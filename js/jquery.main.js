/*
	...
	https://codepen.io/sorinr/pen/zBEzBE/
*/
(function ($){
...
function initSameHeight() {
	jQuery('.featured-video-container').sameHeight({
		elements: '.same-height',
		flexible: true,
		multiLine: true
	});
	jQuery('.uploaded-video-listing').sameHeight({
		elements: '.card',
		flexible: true,
		multiLine: true
	});
...
function initFitVids() {
	...
	jQuery('.featured-video-player').fitVids();
}
/*
